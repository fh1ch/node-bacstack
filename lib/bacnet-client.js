...
module.exports = function(settings) {
  ...
  var processConfirmedServiceRequest = function(address, type, service, maxSegments, maxAdpu, invokeId, buffer, offset, length) {
    ...
    if (service === baEnum.BacnetConfirmedServices.SERVICE_CONFIRMED_READ_PROPERTY) {
      ...
      self.events.emit('readProperty', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('writeProperty', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('readPropertyMultiple', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('writePropertyMultiple', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('covNotifyUnconfirmed', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('atomicWriteFile', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('atomicReadFile', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('subscribeCOV', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('subscribeProperty', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('deviceCommunicationControl', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('reinitializeDevice', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('eventNotifyData', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('readRange', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('createObject', {address: address, invokeId: invokeId, request: result});
      ...
      self.events.emit('deleteObject', {address: address, invokeId: invokeId, request: result});
    } else {
  ...
  var processUnconfirmedServiceRequest = function(address, type, service, buffer, offset, length) {
    ...
    if (service === baEnum.BacnetUnconfirmedServices.SERVICE_UNCONFIRMED_I_AM) {
      ...
      self.events.emit('iAm', {address: address, deviceId: result.deviceId, maxApdu: result.maxApdu, segmentation: result.segmentation, vendorId: result.vendorId});
      ...
      self.events.emit('whoIs', {address: address, lowLimit: result.lowLimit, highLimit: result.highLimit});
      ...
      self.events.emit('whoHas', {address: address, lowLimit: result.lowLimit, highLimit: result.highLimit, objId: result.objId, objName: result.objName});
      ...
      self.events.emit('timeSync', {address: address, dateTime: result.dateTime});
      ...
      self.events.emit('timeSyncUTC', {address: address, dateTime: result.dateTime});
      ...
      self.events.emit('eventNotify', {address: address, eventData: result.eventData});
    } else {
