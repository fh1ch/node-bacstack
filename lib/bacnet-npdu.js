...
module.exports.Decode = function(buffer, offset) {
  ...
  var destination;
  if ((funct & baEnum.BacnetNpduControls.DestinationSpecified) === baEnum.BacnetNpduControls.DestinationSpecified) {
  ...
  var source;
  if ((funct & baEnum.BacnetNpduControls.SourceSpecified) === baEnum.BacnetNpduControls.SourceSpecified) {
  ...
  var vendorId = 0;
  if ((funct & baEnum.BacnetNpduControls.NetworkLayerMessage) === baEnum.BacnetNpduControls.NetworkLayerMessage) {
...
module.exports.Encode = function(buffer, funct, destination, source, hopCount, networkMsgType, vendorId) {
  ...
  buffer.buffer[buffer.offset++] = funct | (hasDestination ? baEnum.BacnetNpduControls.DestinationSpecified : 0) | (hasSource ? baEnum.BacnetNpduControls.SourceSpecified : 0);
  ...
  if ((funct & baEnum.BacnetNpduControls.NetworkLayerMessage) > 0) {
