...
// @see: BACnetPDU ::= CHOICE
module.exports.PduTypes = {
  CONFIRMED_SERVICE_REQUEST: 0,
  UNCONFIRMED_SERVICE_REQUEST: 0x10,
  SIMPLE_ACK: 0x20,
  COMPLEX_ACK: 0x30,
  SEGMENT_ACK: 0x40,
  ERROR: 0x50,
...
// Base PDU Type is encoded as the first 4 bits, followed by 4 1-bit flags.
// this mask simplifies separating the Base and Flags for handling.
module.exports.MASK = 0xF0;

// @see: 20.1.2.11 Format of the BACnet-Confirmed-Request-PDU
module.exports.ConfirmedRequestPduFlags = {
...
module.exports.ComplexAckPduFlags = {
  MORE_FOLLOWS: 4,
  SEGMENTED_MESSAGE: 8,
};

// @see: 20.1.6.6 Format of the BACnet-SegmentACK-PDU
module.exports.SegmentAckPduFlags = {
  SERVER: 1,
  NEGATIVE_ACK: 2,
};
