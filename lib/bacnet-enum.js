...
/**
 * @readonly
 * @enum {BacnetReinitializedStates}
 */
...
/**
 * @readonly
 * @enum {BacnetEnableDisable}
 */
module.exports.BacnetEnableDisable = {
  ENABLE: 0,
  DISABLE: 1,
  DISABLE_INITIATION: 2
};

module.exports.BacnetNotifyTypes = {
  NOTIFY_ALARM: 0,
  NOTIFY_EVENT: 1,
  NOTIFY_ACK_NOTIFICATION: 2
};

module.exports.BacnetEventTypes = {
...
module.exports.BacnetCOVTypes = {
  CHANGE_OF_VALUE_BITS: 0,
  CHANGE_OF_VALUE_REAL: 1
};

module.exports.BacnetTimestampTags = {
  TIME_STAMP_TIME: 0,
...
module.exports.BacnetPropertyStateTypes = {
  BOOLEAN_VALUE: 0,
  BINARY_VALUE: 1,
  EVENT_TYPE: 2,
  POLARITY: 3,
