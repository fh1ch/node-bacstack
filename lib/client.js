...
class Client extends EventEmitter {
  ...
  _processUnconfirmedServiceRequest(address, type, service, buffer, offset, length, addressObject) {
    ...
    if (service === baEnum.UnconfirmedServiceChoice.I_AM) {
      ...
      this.emit('iAm', {address: address, deviceId: result.deviceId, maxApdu: result.maxApdu, segmentation: result.segmentation, vendorId: result.vendorId, snet:net, sadr:adr});
