...
var encode_application_octetString = module.exports.encode_application_octetString = function(buffer, octetString, octetOffset, octetCount) {
...
var encode_application_boolean = module.exports.encode_application_boolean = function(buffer, booleanValue) {
...
var bacapp_encode_context_device_obj_property_ref = module.exports.bacapp_encode_context_device_obj_property_ref = function(buffer, tagNumber, value) {
  encode_opening_tag(buffer, tagNumber);
  bacapp_encode_device_obj_property_ref(buffer, value);
  encode_closing_tag(buffer, tagNumber);
};

var bacapp_encode_property_state = module.exports.bacapp_encode_property_state = function(buffer, value) {
  switch (value.Tag) {
...
var encode_context_bitstring = module.exports.encode_context_bitstring = function(buffer, tagNumber, bitString) {
  var bitStringEncodedLength = 1;
  bitStringEncodedLength += bitstring_bytes_used(bitString);
...
var encode_context_signed = module.exports.encode_context_signed = function(buffer, tagNumber, value) {
  var len = 0;
  if ((value >= -128) && (value < 128)) {
    len = 1;
  } else if ((value >= -32768) && (value < 32768)) {
...
var decode_tagNumber = module.exports.decode_tagNumber = function(buffer, offset) {
  var len = 1;
  var tagNumber;
...
var decode_read_access_result = module.exports.decode_read_access_result = function(buffer, offset, apduLen) {
  ...
  while ((apduLen - len) > 0) {
    ...
    if (result.tagNumber === 4) {
      var localValues = [];
      while ((len + offset) <= buffer.length && !decode_is_closing_tag_number(buffer, offset + len, 4)) {
      ...
      if (!decode_is_closing_tag_number(buffer, offset + len, 4)) return;
...
var decode_signed = module.exports.decode_signed = function(buffer, offset, length) {
  return {
    len: length,
...
var decode_real = module.exports.decode_real = function(buffer, offset) {
  return {
    len: 4,
...
var decode_application_date = module.exports.decode_application_date = function(buffer, offset) {
  var result = decode_tagNumber(buffer, offset);
...
var decode_application_time = module.exports.decode_application_time = function(buffer, offset) {
  var result = decode_tagNumber(buffer, offset);
...
var decode_read_access_specification = module.exports.decode_read_access_specification = function(buffer, offset, apduLen) {
  var len = 0;
  var value = {};
  if (!decode_is_context_tag(buffer, offset + len, 0)) return;
  len++;
...
var bacapp_encode_timestamp = function(buffer, value) {
  switch (value.tag) {
    case baEnum.BacnetTimestampTags.TIME_STAMP_TIME:
      encode_context_time(buffer, 0, value.value);
      break;
    ...
    case baEnum.BacnetTimestampTags.TIME_STAMP_DATETIME:
      bacapp_encode_context_datetime(buffer, 2, value.value);
      break;
...
var bacapp_encode_context_timestamp = module.exports.bacapp_encode_context_timestamp = function(buffer, tagNumber, value) {
...
var decode_context_character_string = module.exports.decode_context_character_string = function(buffer, offset, maxLength, tagNumber) {
  var len = 0;
