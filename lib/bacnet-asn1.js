...
var encodeApplicationNull = function(buffer) {
  buffer.buffer[buffer.offset++] = baEnum.BacnetApplicationTags.BACNET_APPLICATION_TAG_NULL;
};
...
var bacappEncodeApplicationData = module.exports.bacappEncodeApplicationData = function(buffer, value) {
  if (value.value === null) {
    value.type = baEnum.BacnetApplicationTags.BACNET_APPLICATION_TAG_NULL;
  }
  switch (value.type) {
