...
var get_encoding_type = function(encoding, decodingBuffer, decodingOffset) {
  switch (encoding) {
...
var multiCharsetCharacterstringDecode = function(buffer, offset, maxLength, encoding, length) {
  return {
    value: buffer.toString(get_encoding_type(encoding, buffer, offset), offset, offset + length),
    len: length + 1,
    encoding: encoding
  };
};
...
var encodeBacnetCharacterString = function(buffer, value, encoding) {
  ...
  var bufEncoded = iconv.encode(value, get_encoding_type(encoding));
